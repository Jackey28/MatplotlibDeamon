...
map_pth = "/home/xiaoke/private/dataset/DBLP-Scholar/origin/DBLP-Scholar_perfectMapping.csv"
l_pth = "/home/xiaoke/private/dataset/DBLP-Scholar/origin/DBLP1.csv"
r_pth = "/home/xiaoke/private/dataset/DBLP-Scholar/origin/Scholar.csv"
...
if __name__ == '__main__':
	...
	for index, row in map_csv.iterrows():
		...
		r_slice = r_csv.loc[r_csv['id'] == (row['idScholar'])]
		sim_tuple = []
		del l_slice['id']
		for i in l_slice:
