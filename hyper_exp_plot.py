...
axs[0, 0].set_title('(a) DBLP-ACM: Varying $||B||$', fontdict=font1)
...
axs[0, 1].set_title('(b) Walmart: Varying $||B||}$', fontdict=font1)
...
# axs[0, 1].set_xlabel('$|B|$', fontdict=font1)
axs[0, 2].set_title('(c) Songs: Varying $||B||$', fontdict=font1)
...
# axs[0, 1].set_xlabel('$|B|$', fontdict=font1)
axs[0, 3].set_title('(d) NCV: Varying $||B||$', fontdict=font1)
