...
axs[0, 0].plot(x_, disdedup, marker='o', color='olive', linestyle=(0,(5,1)), label='Disdedup')
...
axs[0, 0].set_ylabel('time ($log$ sec.)', fontdict=font1)
...
#hyper_tqm = [5,5,5,5,5]
x = [1, 2, 3, 4, 5,6,7]
axs[1, 0].plot(x, hyper, marker='x', color='orange',  linestyle="--", markersize=7)
...
axs[2, 0].plot(x, time_hyper,color='orange', linestyle=":", markersize=5)
axs[2, 0].plot(x, time_randome_allocation_threads,linestyle=":",color='royalblue', markersize=5)
...
axs[2, 0].set_xlim([0, 127])
axs[2, 0].set_ylabel('time (sec.)', fontdict=font1)
axs[2, 0].set_xlabel('$block$ $id$', fontdict=font1)
axs[2, 0].set_title('(a) TPCH: handling skewness$', fontdict=font1)
axs[2, 0].tick_params(labelsize=10)
