...
map_pth = "E:\project\ER_Dataset\ER\Walmart-Amazon-common/map.csv"
l_pth = "E:\project\ER_Dataset\ER\Walmart-Amazon-common/tableA.csv"
r_pth = "E:\project\ER_Dataset\ER\Walmart-Amazon-common/tableB.csv"
...
if __name__ == '__main__':
	...
	for index, row in map_csv.iterrows():
		l_slice = l_csv.loc[l_csv['id'] == (row['id1'])]
